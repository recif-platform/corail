...
class TestChat:
    ...
    async def test_passes_history_on_followup(
        self, client: httpx.AsyncClient, mock_pipeline: AsyncMock
    ) -> None:
    ...
    async def test_sets_title_on_first_message(
        self, client: httpx.AsyncClient, storage: MemoryStorage
    ) -> None:
