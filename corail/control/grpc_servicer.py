...
class ControlServiceServicer(pb2_grpc.ControlServiceServicer):
    ...
    def ListConversations(
        self,
        request: pb2.ListConversationsRequest,
    ...
    def GetConversation(
        self,
        request: pb2.GetConversationRequest,
        context: grpc.ServicerContext,
        ...
        return pb2.GetConversationResponse(
            ...
            messages=[pb2.Message(role=m["role"], content=m["content"]) for m in data.get("messages", [])],
        )

    def DeleteConversation(
        self,
        request: pb2.DeleteConversationRequest,
        context: grpc.ServicerContext,
    ...
    def GetGenerationStatus(
        self,
        request: pb2.GetGenerationStatusRequest,
        context: grpc.ServicerContext,
    ...
    def ListMemories(
        self,
        request: pb2.ListMemoriesRequest,
        context: grpc.ServicerContext,
    ...
    def MemoryStatus(
        self,
        request: pb2.MemoryStatusRequest,
        context: grpc.ServicerContext,
    ...
    def StoreMemory(
        self,
        request: pb2.StoreMemoryRequest,
        context: grpc.ServicerContext,
    ...
    def SearchMemories(
        self,
        request: pb2.SearchMemoriesRequest,
        context: grpc.ServicerContext,
    ...
    def DeleteMemory(
        self,
        request: pb2.DeleteMemoryRequest,
        context: grpc.ServicerContext,
    ...
    def UpdateConfig(
        self,
        request: pb2.UpdateConfigRequest,
        context: grpc.ServicerContext,
    ...
    def Reload(
        ...
        result = _run_async(
            self._bridge._commands.execute(
                "reload",
                {
    ...
    def Evaluate(
        self,
        request: pb2.EvaluateRequest,
        context: grpc.ServicerContext,
    ) -> pb2.EvaluateResponse:
        # Convert proto repeated EvalCase to list[dict]
        dataset = [{"input": c.input, "expected_output": c.expected_output} for c in request.cases]
        ...
        if request.scorers_config_json:
            scorers_config = {
                name: json.loads(config_json) for name, config_json in request.scorers_config_json.items()
            }
    ...
    def StreamEvents(
        self,
        request: pb2.StreamEventsRequest,
        context: grpc.ServicerContext,
    ) -> Any:
