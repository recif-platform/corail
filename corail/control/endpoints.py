...
async def get_generation_status(
    active_generations: dict[str, str], cid: str
) -> dict[str, Any]:
...
async def search_memories(
    memory: MemoryManager | None, query: str, top_k: int = 10
) -> list[dict[str, Any]]:
...
async def delete_memory_entry(
    memory: MemoryManager | None, entry_id: str
) -> dict[str, Any]:
...
async def handle_evaluate(
    ...
    """
    from corail.evaluation.mlflow_evaluator import EvalRunResult, MLflowEvaluator
