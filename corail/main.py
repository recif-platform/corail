...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    app.state.pipeline = Pipeline(registry)
    ...
    from corail.config import Settings  # noqa: PLC0415
    ...
    from corail.control.bridge import RecifBridge  # noqa: PLC0415
    from corail.events.bus import EventBus  # noqa: PLC0415
