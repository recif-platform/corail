...
_RISK_PROFILE_SCORERS: dict[str, list[str]] = {
    ...
    "standard": ["safety", "relevance_to_query", "correctness", "tool_call_correctness"],
    "high": ["safety", "relevance_to_query", "correctness", "completeness", "tool_call_correctness", "tool_call_efficiency", "retrieval_groundedness"],
}
...
class MLflowEvaluator:
    ...
    def __init__(self, judge_model: str | None = None) -> None:
        self._judge_model = judge_model or os.environ.get(
            "RECIF_JUDGE_MODEL", "vertex_ai:/gemini-2.5-pro"
        )
